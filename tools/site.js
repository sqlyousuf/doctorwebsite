...
const PAGES = [
  ...
  { path: '/procedures/gastric-sleeve.html', priority: '0.9' },
  { path: '/procedures/gastric-bypass.html', priority: '0.9' },
  { path: '/procedures/gastric-balloon.html', priority: '0.8' },
  { path: '/procedures/lap-band.html', priority: '0.8' },
  { path: '/procedures/revision-bariatric-surgery.html', priority: '0.8' },
  { path: '/procedures/general-surgery.html', priority: '0.7' },
  { path: '/procedures/laparoscopic-surgery.html', priority: '0.7' },
